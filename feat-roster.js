...
(function () {
  ...
  (function injectCSS() {
    ...
    var css = [
      ...
      '#heroes .ros-feat{flex:1 1 auto;min-height:0;overflow:auto;padding:8px 16px 10px;display:flex;gap:18px}',
      '#heroes .ros-feat .dt-art{flex:none;width:clamp(168px,26%,260px);align-self:flex-start;border-radius:14px;overflow:hidden;border:2px solid var(--line);position:relative}',
      ...
      '#heroes .ros-feat .dt-info h2{margin:0 0 3px;font-size:23px;display:flex;align-items:center;gap:9px;flex-wrap:wrap}',
      ...
      '#heroes .ros-feat .meta{color:var(--muted);font-size:12px;margin-bottom:10px}',
      '#heroes .ros-feat .statgrid{display:grid;grid-template-columns:1fr 1fr;gap:0 22px}',
      '#heroes .ros-feat .statrow{display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid var(--line);font-size:13px}',
      '#heroes .ros-feat .statrow b{color:var(--gold)}',
      '#heroes .ros-feat .seclab{margin:12px 0 4px;font-weight:800;font-size:13px}',
      '#heroes .ros-feat .skill{display:flex;gap:9px;padding:8px 0;border-bottom:1px solid var(--line)}',
      '#heroes .ros-feat .skill .si{width:34px;height:34px;border-radius:9px;background:#2a2342;display:flex;align-items:center;justify-content:center;font-size:16px;flex:none}',
      '#heroes .ros-feat .skill .sn{font-size:12.5px;font-weight:700}',
      '#heroes .ros-feat .skill .sd{font-size:10.5px;color:var(--muted)}',
      '#heroes .ros-feat .acts{margin-top:14px;display:flex;gap:8px;flex-wrap:wrap}',
      // bottom strip
      '#heroes .ros-strip{flex:none;border-top:1px solid var(--line);background:linear-gradient(0deg,rgba(8,8,16,.92),rgba(12,12,22,.72));padding:6px 12px 9px;backdrop-filter:blur(4px)}',
      '#heroes .ros-bar{display:flex;align-items:center;gap:6px;overflow-x:auto;padding:2px 0 6px;scrollbar-width:thin}',
      ...
      '#heroes .ros-track{display:flex;gap:8px;overflow-x:auto;padding:9px 2px 6px;scroll-behavior:smooth;scrollbar-width:thin}',
      '#heroes .ros-card{flex:0 0 auto;width:84px;height:120px;border-radius:11px;position:relative;overflow:hidden;cursor:pointer;border:1.5px solid var(--line);transition:transform .15s,box-shadow .15s,border-color .15s}',
      ...
      '#heroes .ros-card .ele{position:absolute;top:4px;left:4px;width:14px;height:14px;border-radius:50%;border:1px solid #fff6}',
      '#heroes .ros-card .stars{position:absolute;top:4px;right:5px;font-size:8px;color:var(--gold);text-shadow:0 1px 2px #000}',
      '#heroes .ros-card .lv{position:absolute;top:20px;left:4px;font-size:8px;font-weight:800;color:#1c1407;background:linear-gradient(135deg,var(--gold),#d99a2b);padding:0 5px;border-radius:7px}',
      '#heroes .ros-card .nm{position:absolute;left:0;right:0;bottom:0;padding:11px 4px 3px;font-size:9px;font-weight:700;text-align:center;color:#fff;background:linear-gradient(0deg,rgba(0,0,0,.85),transparent);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      '#heroes .ros-card.locked img{filter:grayscale(1) brightness(.52)}',
      '#heroes .ros-card .lk{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:20px;pointer-events:none;filter:drop-shadow(0 1px 3px #000)}',
